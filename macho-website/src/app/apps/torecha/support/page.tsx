...
export default function TorechaSupportPage() {
  return (
    <TorechaDocument title="サポート" lead="トレチャの設定、データ、アカウントについてのご案内です。">
      ...
      <section><h2>オンラインバックアップ</h2><p>設定画面の「オンラインバックアップ」からAppleまたはGoogleでログインすると、プレミアムプランでバックアップを利用できます。復元すると端末内の対象記録がクラウド上の記録で置き換わります。写真ファイル本体は復元されません。</p></section>
