...
export default function TorechaPrivacyPage() {
  return (
    <TorechaDocument title="プライバシーポリシー" lead="制定日：2026年9月6日。トレチャ（以下「本アプリ」）は、利用者の情報を以下の方針に基づき取り扱います。">
      <section><h2>1. 取得する情報</h2><ul><li>AppleまたはGoogleログインに必要な識別情報、メールアドレス等</li><li>トレーニング、体組成、食事、キャラクター、ジム利用に関する記録</li><li>ジムへの入退場判定に必要な位置情報</li><li>AI機能で利用者が送信した画像、質問および関連する記録</li><li>利用者が許可したAppleヘルスケア上の体重、体脂肪率、ウエストおよび身長</li><li>購入状況、広告識別子、端末・アプリの動作情報</li></ul></section>
      <section><h2>2. 利用目的</h2><p>本アプリの機能提供、ジム入退場の自動記録、オンラインバックアップ、AIによる食事分析と助言、ヘルスケアデータの取り込み、課金状況の確認、広告配信、不具合調査およびセキュリティ確保のために利用します。</p></section>
      ...
      <section><h2>5. AI機能</h2><p>利用者が選択した画像、質問および関連する記録は、栄養情報の推定や回答の作成に利用します。結果は推定値であり、医療上の判断には利用できません。</p></section>
